...
import {MilkToken} from "../src/MilkToken.sol";
...
contract DeployMerkleAirdrop is Script {
    ...
    function deployMerkleAirdrop() public returns (MerkleAirdrop, MilkToken) {
        vm.startBroadcast();
        MilkToken token = new MilkToken();
    ...
    function run() external returns (MerkleAirdrop, MilkToken) {
